...
const char* ei_classifier_inferencing_categories[] = { "falling", "goingstair", "rest", "running", "walking" };

uint8_t ei_dsp_config_17_axes[] = { 0, 1, 2, 3, 4, 5 };
const uint32_t ei_dsp_config_17_axes_size = 6;
ei_dsp_config_flatten_t ei_dsp_config_17 = {
    17, // uint32_t blockId
...
const ei_learning_block_config_anomaly_kmeans_t ei_learning_block_config_19 = {
    .implementation_version = 1,
...
const uint32_t ei_learning_block_19_inputs[1] = { 17 };
...
const ei_impulse_t impulse_525088_0 = {
    ...
    .fusion_string = "Acc_X + Acc_Y + Acc_Z + Gyro_X + Gyro_Y + Gyro_Z",
    .slice_size = (5/4),

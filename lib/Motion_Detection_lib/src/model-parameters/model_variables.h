...
const char* ei_classifier_inferencing_categories[] = { "goingstair", "idle", "running", "walking" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_24_axes[] = { 0, 1, 2, 3, 4, 5 };
const uint32_t ei_dsp_config_24_axes_size = 6;
...
ei_learning_block_config_tflite_graph_t ei_learning_block_config_22 = {
    .implementation_version = 1,
...
const uint32_t ei_learning_block_22_inputs[1] = { 24 };
